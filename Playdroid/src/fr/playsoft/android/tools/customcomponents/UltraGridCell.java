...
import fr.playsoft.android.tools.customcomponents.interfaces.IUltraGridCellCheckBoxChecked;
import fr.playsoft.android.tools.customcomponents.interfaces.IUltraGridCellConfig;
import fr.playsoft.android.tools.customcomponents.interfaces.IUltraGridCellImageButtonClick;
...
/**
 * Object representing single cell in UltraGrid.
 * 
...
{
	/** Tag for LogCat **/
	private static final String TAG = "UltraGridCell";
	
	/** Constant with empty string to avoid bugs **/
	public static final String EMPTY_STRING = "";
	
	/** Our own instance **/
	private UltraGridCell mInstance;
	...
	/** Cell configuration **/
	private static IUltraGridCellConfig sCellConfig;
	 ...
	 */
	public static void setCellConfiguration( IUltraGridCellConfig pConfiguration )
	{
	 ...
	 */
	public static IUltraGridCellConfig getCellConfiguration()
	{
		return sCellConfig;
	}
	 ...
	 */
	public UltraGridCell( int pType , ElementCell... pElements )
	{
		mInstance = this;
		mType = pType;
	...
	public View createView( LayoutInflater pInflater , final IRefreshable pParentView , boolean pIsAutoDownloadEnabled , int pListId , int pPosition ,
			IUltraGridDrawableProvider pDrawableProvider , IUltraGridDataProvider pDataProvider )
	{
		View lCellView = pInflater.inflate( sCellConfig.getCellLayoutId( mType ) , null , false );
		updateView( lCellView , pParentView , pIsAutoDownloadEnabled , pListId , pPosition , pDrawableProvider , pDataProvider );
		return lCellView;
	}
	 ...
	 * @param pDataProvider Data provider that will be called when view is updated.
	 */
	public void updateView( View pView , final IRefreshable pParentView , boolean pIsAutoDownloadEnabled , int pListId , int pPosition ,
			final IUltraGridDrawableProvider pDrawableProvider , IUltraGridDataProvider pDataProvider )
	{
		if ( mCustomBackgroundDrawable != null )
		{
			pView.setBackgroundDrawable( mCustomBackgroundDrawable );
		}
		pDataProvider.onUltraGridCellUpdated( pListId , pPosition , this , pView );
		...
		for ( ElementCell lElement : mCellElements )
		{
			...
			{
				case IUltraGridCellConfig.ELEMENT_TYPE_STRING:
				...
				case IUltraGridCellConfig.ELEMENT_TYPE_IMAGE:
				...
				case IUltraGridCellConfig.ELEMENT_TYPE_IMAGEBUTTON:
					...
					final IUltraGridCellImageButtonClick lImageButtonClickListener = (IUltraGridCellImageButtonClick) lElement.mElementValue;
					lImageButton.setOnClickListener( new View.OnClickListener()
					{
						@Override
						public void onClick( View v )
						{
							lImageButtonClickListener.onImageButtonClick( mInstance , lImageButtonElementId );
						}
					} );
					lImageButton.setFocusable( false );
					break;
				
				case IUltraGridCellConfig.ELEMENT_TYPE_CHECKBOX:
					...
					final IUltraGridCellCheckBoxChecked lCheckBoxCheckedListener = (IUltraGridCellCheckBoxChecked) lElement.mElementValue;
					lCheckBox.setOnCheckedChangeListener( new OnCheckedChangeListener()
					{
						@Override
						public void onCheckedChanged( CompoundButton buttonView , boolean isChecked )
						{
							lCheckBoxCheckedListener.onCheckBoxCheckedChanged( mInstance , lCheckBoxElementId , isChecked );
						}
					} );
					lCheckBox.setFocusable( false );
					lCheckBox.setChecked( lCheckBoxCheckedListener.getInitialCheckboxIsChecked( mInstance , lCheckBoxElementId ) );
					break;
			}
		}
	}
